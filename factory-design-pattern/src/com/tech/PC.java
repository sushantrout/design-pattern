...
public class PC implements Computer {
	...
	public PC(String ram, String hdd, String cpu, boolean isGraphicsEnable, boolean isBlutouthEnable) {
		super();
		this.ram = ram;
		this.hdd = hdd;
		this.cpu = cpu;
	...
	public String toString() {
		return "PC [ram=" + ram + ", hdd=" + hdd + ", cpu=" + cpu + ", isGraphicsEnable=" + isGraphicsEnable
